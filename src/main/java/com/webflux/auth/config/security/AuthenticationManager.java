...
import static com.webflux.auth.config.AppConstants.AUTHORITIES_KEY;
...
public class AuthenticationManager implements ReactiveAuthenticationManager {
    ...
    public Mono<Authentication> authenticate(Authentication authentication) {
        ...
        if (username != null && !tokenProvider.isTokenExpired(authToken)) {
            ...
            SecurityContextHolder.getContext().setAuthentication(new AuthenticatedUser(username, true, authorities));
